...
if __name__ == "__main__":
    ...
    fp8_linear = os.getenv('FP8_LINEAR')
    disable_fp8 = os.getenv('DISABLE_FP8')
    disable_fp8_mlp_linear2 = os.getenv('DISABLE_FP8_MLP_LINEAR2')
    scaled_swiglu = os.getenv('SCALED_SWIGLU')
    detach_scaled_swiglu = os.getenv('DETACH_SCALED_SWIGLU')
    delayed_scaled_swiglu = os.getenv('DELAYED_SCALED_SWIGLU')
    fp8_optimizer = os.getenv('FP8_OPTIMIZER')
    mw_dtype = os.getenv('MW_DTYPE')
    m1_dtype = os.getenv('M1_DTYPE')
    m2_dtype = os.getenv('M2_DTYPE')
    sftz = os.getenv('SFTZ')

    print(f'FP8_LINEAR: {fp8_linear}')
    print(f'DISABLE_FP8: {disable_fp8}')
    print(f'DISABLE_FP8_MLP_LINEAR2: {disable_fp8_mlp_linear2}')
    print(f'SCALED_SWIGLU: {scaled_swiglu}')
    print(f'DETACH_SCALED_SWIGLU: {detach_scaled_swiglu}')
    print(f'DELAYED_SCALED_SWIGLU: {delayed_scaled_swiglu}')
    print(f'FP8_OPTIMIZER: {fp8_optimizer}')
    print(f'MW_DTYPE: {mw_dtype}')
    print(f'M1_DTYPE: {m1_dtype}')
    print(f'M2_DTYPE: {m2_dtype}')
    print(f'SFTZ: {sftz}')
